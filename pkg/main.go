...
import (
	...
	"github.com/ricoberger/grafana-cloudflare-plugin/pkg/plugin"
...
func main() {
	...
	// factory.
	if err := datasource.Manage("ricoberger-cloudflare-datasource", plugin.NewDatasource, datasource.ManageOpts{}); err != nil {
